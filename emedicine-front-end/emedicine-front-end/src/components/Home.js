...
const Home = () => {
 ...
 const handleProceedToCheckout = () => {
  navigate("/cart"); // Navigate to Cart.js page
  handleClosePopover(); // Close the popover after navigating
 };
...
const buttonStyle = {
 backgroundColor: "green", // Add gradient for a dynamic look
 color: "white", // Text color
 padding: "1rem 2rem", // Increase padding for a bigger button
 borderRadius: "100px", // Make it fully rounded
 ...
 marginBottom: "1rem", // Keep the bottom margin
};
